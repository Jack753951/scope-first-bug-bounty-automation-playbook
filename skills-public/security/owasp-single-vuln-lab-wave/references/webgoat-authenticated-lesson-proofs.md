...
- `<lab-vm>` is the tester/attacker VM.
- `<lab-vm>` is the Docker target host.
...
- `kali-output/<run_id>/summary.md`
- `kali-output/<run_id>/observations.jsonl`
- `kali-output/<run_id>/authenticated_gets.csv`
- `kali-output/<run_id>/lessons/<Lesson>.lesson.html`
