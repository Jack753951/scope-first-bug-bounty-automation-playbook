...
6. Target-touching execution stays on the tool lab (`<lab-vm>` for this project) and only against authorized local/CTF/client/scope-approved targets.
...
- artifacts pulled back to repo-local `kali-output/` or equivalent;
