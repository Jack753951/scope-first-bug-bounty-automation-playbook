...
> **Note (2026-05-28):** Active vault for this project is `<user-home>\Documents\ObsidianProjects\Projects\Cybersec Lab - 2`. Repo at `<private-workspace>` keeps only a frozen snapshot at `notes/archive_20260528/obsidian_projects/Cybersec Lab.md`.
