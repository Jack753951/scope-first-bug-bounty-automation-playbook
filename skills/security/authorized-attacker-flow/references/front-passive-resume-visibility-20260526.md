...
# <program-name> passive-only resume visibility checkpoint (2026-05-26)
...
- Existing screenshots showed useful <program-name> onboarding/setup-guide evidence, but the current visible Kali workspaces only showed the desktop and no visible <program-name> browser window.
