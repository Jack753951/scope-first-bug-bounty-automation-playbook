...
Use this reference when the operator has already confirmed that a <bug-bounty-platform>/live-bounty target is in scope and the test uses only operator-owned accounts/objects.
